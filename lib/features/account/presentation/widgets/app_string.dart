...
class AppStrings {
  ...
  static String get homeChefsSubtitle =>
      AppLanguageConstants.t(
  ...
  static String get useCurrentLocationSubtitle =>
      AppLanguageConstants.t(
        'Automatically detect your address',
        'আপনার ঠিকানা স্বয়ংক্রিয়ভাবে শনাক্ত করুন',
      );

  static String get currentLocationDetected =>
      AppLanguageConstants.t(
        'Current location detected',
        'বর্তমান অবস্থান শনাক্ত হয়েছে',
      );

  static String get unableToDetectLocation =>
      AppLanguageConstants.t(
        'Unable to detect your location',
        'আপনার অবস্থান শনাক্ত করা যায়নি',
      );
  ...
  static String get pleaseEnableLocation =>
      AppLanguageConstants.t(
        'Please enable location services',
        'অনুগ্রহ করে লোকেশন সার্ভিস চালু করুন',
      );
  ...
  static String get selectVillageOrArea =>
      AppLanguageConstants.t(
        'Select village / area',
        'গ্রাম / এলাকা নির্বাচন করুন',
      );

  static String get selectCountryFirst =>
      AppLanguageConstants.t(
        'Select country first',
        'প্রথমে দেশ নির্বাচন করুন',
      );

  static String get selectStateFirst =>
      AppLanguageConstants.t(
        'Select state first',
        'প্রথমে রাজ্য নির্বাচন করুন',
      );
  ...
  static String get nearbyLandmark =>
      AppLanguageConstants.t(
        'Nearby Landmark',
        'নিকটবর্তী ল্যান্ডমার্ক',
      );

  static String get nearbyLandmarkHint =>
      AppLanguageConstants.t(
        'Nearby landmark (optional)',
        'নিকটবর্তী ল্যান্ডমার্ক (ঐচ্ছিক)',
      );
  ...
  static String get saveAddress =>
      ...
      static String get contactUs => AppLanguageConstants.t('Contact Us', 'যোগাযোগ করুন');
static String get myProfile => AppLanguageConstants.t('My Profile', 'আমার প্রোফাইল');
static String get myAddress => AppLanguageConstants.t('My Address', 'আমার ঠিকানা');
//static String get language => AppLanguageConstants.t('Language', 'ভাষা');
static String get englishOption => AppLanguageConstants.t('English', 'English');
...
static String get logOutConfirmTitle => AppLanguageConstants.t('Log Out', 'লগ আউট');
