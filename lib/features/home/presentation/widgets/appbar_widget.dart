...
/// ===============================================================
///
/// Notification badge-er count ekhon globally
/// CartService theke asbe.
///
/// Je kono page theke:
///
...
/// );
///
/// call korlei notification badge automatically update hobe.
///
/// ===============================================================

class LalBabaAppBar extends StatelessWidget
    implements PreferredSizeWidget {
  /// Ei 2ta parameter compatibility-r jonno rakha holo.
  /// Existing page-e pass korleo error hobe na.
  ///
  /// Kintu notification badge-er actual count
  /// CartService.count theke asbe.
  final int cartCount;
  final int notificationCount;
  ...
  // =======================================================================
  //
  // Future-e jodi cart icon abar enable koro,
  // etao same global count use korbe.
  // =======================================================================
